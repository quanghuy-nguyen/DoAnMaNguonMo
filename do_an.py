...
DEFAULT_TELEGRAM_BOT_TOKEN = '6919868734:AAGd4_aueQguDdLM4rzUXW5IdRPS8MhzmeU'
DEFAULT_TELEGRAM_CHAT_ID = '1886522458'
...
class Window(Tk):
    def __init__(self):
        ...
        # Display default values in entry fields
        self.update_entry_fields()

    def update_entry_fields(self):
        # Display default values in entry fields
        self.telegram_token_var.set(DEFAULT_TELEGRAM_BOT_TOKEN)
        self.telegram_chat_id_var.set(DEFAULT_TELEGRAM_CHAT_ID)
