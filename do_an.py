        ...
        if ret:
            ...
            if self.is_recording:
                if self.video_writer is None:
                    ...
                    video_name = datetime.now().strftime("%H_%M_%d_%m_%Y") + ".mp4"
                    self.video_writer = cv2.VideoWriter(video_name, fourcc, 20.0, (width, height))
            ...
            video_name = datetime.now().strftime("%H_%M_%S_%d/%m/%Y") + "recorded_video.avi"
            print(video_name)
